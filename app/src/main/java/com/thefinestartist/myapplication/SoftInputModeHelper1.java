...
public class SoftInputModeHelper1 {
    ...
    private SoftInputModeHelper1(final Activity activity, SoftKeyboardListener listener) {
    ...
    private void possiblyResizeChildOfContent() {
        ...
        if (usableHeightNow != usableHeightPrevious) {
            ...
            if (heightDifference > (usableHeightSansKeyboard / 4)) {
                ...
                layoutParams.topMargin = heightDifference;
                if (listener != null)
